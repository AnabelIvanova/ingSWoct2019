...
public class GUI_RegistroRutas extends javax.swing.JFrame {
    ...
    private void table_rutasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_rutasMouseClicked
      int row = (int)  table_rutas.getSelectedRow();
        ...
        String costo_r = (String) table_rutas.getModel().getValueAt(row, 3);
        String hora_r = (String) table_rutas.getModel().getValueAt(row, 4);
        String fecha_r = (String) table_rutas.getModel().getValueAt(row, 4);
